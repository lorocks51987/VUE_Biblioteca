function traducaoComponentes() {
  /*Internacionalização pt-BR*/
  ejs.base.setCulture('pt-BR');
  ejs.base.loadCldr(currencyData, numbers, languages, caGregorian, currencies, timeZoneNames, numberingSystems);

  /*Tradução dos componentes*/
  const traducaoComponentes = {
    "pt-BR": {
      "tab": {
      ...
      "spreadsheet": {
        ...
        "LightRedFillWithDarkRedText": "Preenchimento Vermelho Limpar com Texto Vermelho Escuro",
